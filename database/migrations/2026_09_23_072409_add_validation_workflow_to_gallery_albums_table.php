...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // drop and re-add as a plain string instead, cast to GalleryStatus in the model.
        Schema::table('gallery_albums', function (Blueprint $table) {
            $table->dropColumn('status');
        });

        Schema::table('gallery_albums', function (Blueprint $table) {
            $table->string('status')->default('brouillon')->after('cover_image');
    ...
    public function down(): void
    {
        ...
        Schema::table('gallery_albums', function (Blueprint $table) {
            $table->enum('status', ['brouillon', 'publie'])->default('brouillon')->after('cover_image');
        });
    }
};
