    ...
    return (
        <section className="mx-auto max-w-6xl px-6 py-20">
            <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-[220px_1fr]">
                ...
                />
                <div>
                    <h2 className="text-xl font-bold text-isstm-navy sm:text-2xl dark:text-white">{t('accueil.mot_directeur_titre', 'Le mot du Directeur')}</h2>
                    ...
                    <p className="mt-4 text-sm font-semibold text-isstm-navy dark:text-white">
                        ...
                        <span className="ml-1.5 font-normal text-slate-500 dark:text-slate-400">{t('accueil.directeur_fonction', "Directeur de l'ISSTM")}</span>
                    </p>
                    <Link
