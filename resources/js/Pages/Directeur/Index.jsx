    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <main className="mx-auto max-w-4xl px-6 py-12">
                <article className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100 sm:p-10">
                    <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
                        ...
                        />
                        <div>
                            <blockquote className="flex gap-3 text-lg leading-relaxed text-slate-600 italic">
