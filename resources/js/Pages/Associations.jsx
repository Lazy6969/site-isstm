        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="bg-isstm-navy py-14 text-white">
                <div className="mx-auto max-w-4xl px-6">
                    ...
                    <h1 className="mt-2 text-3xl font-bold">Clubs et Associations</h1>
            ...
            <main className="mx-auto max-w-4xl space-y-12 px-6 py-12">
                <div className="flex justify-center">
                    <img src="/images/aei.jpeg" alt="Logo AEI" className="h-20 w-20 rounded-full object-cover ring-4 ring-isstm-gold/30" />
                </div>

                <section className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-slate-100">
                    <h2 className="text-lg font-semibold text-isstm-navy">Carte d'Identité de l'Association</h2>
                    ...
                    <div className="mt-5 border-t border-slate-100 pt-5">
                        <dt className="text-xs font-medium uppercase tracking-wide text-slate-400">Membres d'honneur</dt>
                        <dd className="mt-1 text-sm text-slate-700">Directeur et Directeur Adjoint de l'ISSTM</dd>
                    </div>
                </section>

                <section>
                    <h2 className="text-lg font-semibold text-isstm-navy">Composition du Bureau Exécutif</h2>
                    <p className="mt-1 text-sm text-slate-500">Article 13 des statuts</p>
                    <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                        {bureauRoles.map((item) => (
                            <div key={item.role} className="rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
                ...
                <section>
                    <h2 className="text-lg font-semibold text-isstm-navy">Bureau fondateur</h2>
                    <p className="mt-1 text-sm text-slate-500">Élu lors du procès-verbal du 10 mai 2022</p>
                    <ul className="mt-5 divide-y divide-slate-100 overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-slate-100">
