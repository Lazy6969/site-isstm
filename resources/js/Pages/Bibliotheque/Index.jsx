            ...
            <div className="mb-10 grid gap-4 sm:grid-cols-2">
                <Link href="/bibliotheque/canevas" className="block">
                    <Card className="p-6 transition hover:border-isstm-navy/30 hover:shadow-md">
                        <h2 className="flex items-center gap-2 font-semibold text-isstm-navy">
            ...
            <div className="grid gap-8 sm:grid-cols-2">
                <section>
                    ...
                    <div className="space-y-2">
                        {derniersCanevas.length === 0 && <p className="text-sm text-slate-400">{t('bibliotheque.aucun_canevas', 'Aucun canevas pour le moment.')}</p>}
                ...
                <section>
                    ...
                    <div className="space-y-2">
                        {derniersMemoires.length === 0 && <p className="text-sm text-slate-400">{t('bibliotheque.aucun_memoire', 'Aucun mémoire pour le moment.')}</p>}
